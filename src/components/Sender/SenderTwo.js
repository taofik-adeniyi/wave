  ...
  return (
    ...
    <div className="wrapper">
      ...
      <div className="address">
        <div>To Address</div>
        <div style={{borderBottom: '2px solid blue'}}>To Wavewallet Account</div>
      </div>
      <div className="info" style={{textAlign: 'center'}}>You can choose to send to an email address or a phone number registered on Wavewallet</div>
      ...
      <div className="wrapper" style={{textAlign: 'center'}}>
              ...
              <p>
                  Share the address below to receive Bitcoin (BTC) into your Wavewallet account
              </p>
...
type="text" placeholder="Name of plan" value="" className="dinput" />
<input style={{
                    outline: 'none',
                    width: '90%',
                    backgroundColor: '#F5F6F6',
...
type="text" placeholder="BTC" value="" className="dinput" />
<input style={{
                    outline: 'none',
                    width: '90%',
                    backgroundColor: '#F5F6F6',
...
type="text" placeholder="Amount" value="" className="dinput" />
<input style={{
                    outline: 'none',
                    width: '90%',
                    backgroundColor: '#F5F6F6',
...
type="text" placeholder="Select saving frequency" value="" className="dinput" />
<input style={{
                    outline: 'none',
                    width: '90%',
                    backgroundColor: '#F5F6F6',
...
type="text" placeholder="Start date" value="" className="dinput" />
<input style={{
                    outline: 'none',
                    width: '90%',
                    backgroundColor: '#F5F6F6',
...
type="text" placeholder="End date" value="" className="dinput" />
<div>
  <button style={{backgroundColor: '#F5F6F6', width: '100%', color: '#D8DADD'}}>Buy</button>
</div>
<div style={{textAlign: 'center'}}>
    <div style={{textAlign: 'center', marginBottom: '60px'}}>Confirm recurring buy</div>
  ...
  <button style={{width: '100%', marginTop: '50px'}}>Confirm</button>
</div>
</div>
    </div>
    <div style={{textAlign: 'center'}}>
        <div>Recurring buy created Successfully</div>
        <p>You have Successfully craeted a recurring buy for 100,000 NGN worth of BTC per month</p>
